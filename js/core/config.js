...
const PERMISOS = {
  ...
  mecanico:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:true,  diagnostico_obd:true,  bitacora:true, ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  armeria:true,  agroservicio:false, venta_granos:false, inventario:true,  bodegas:true,  proveedores:false, compras:false, activos:false, envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
