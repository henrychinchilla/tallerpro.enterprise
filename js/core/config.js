...
/* ── PERMISOS POR ROL ─────────────────────────────── */
const PERMISOS = {
  superadmin:   { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:true,  bitacora:true, ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:true,  bancos:true,  finanzas:true,  presupuesto:true,  contabilidad:true,  rrhh:true,  marketing:true,  calendario:true,  comunicaciones:true,  configuracion:true,  usuarios:true,  admin:true,  mi_ot:false, doc_empresa:true  },
  admin:        { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:true,  bitacora:true, ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:true,  bancos:true,  finanzas:true,  presupuesto:true,  contabilidad:true,  rrhh:true,  marketing:true,  calendario:true,  comunicaciones:true,  configuracion:true,  usuarios:true,  admin:true,  mi_ot:false, doc_empresa:true  },
  gerente_tal:  { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:true,  bitacora:true, ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:true,  marketing:true,  calendario:true,  comunicaciones:true,  configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:true  },
  ...
  mecanico:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:true,  diagnostico_obd:true,  bitacora:true, ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:false, venta_granos:false, inventario:true,  bodegas:true,  proveedores:false, compras:false, activos:false, envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
