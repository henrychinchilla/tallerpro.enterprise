...
const PERMISOS = {
  ...
  admin:        { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:true,  ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:true,  bancos:true,  finanzas:true,  presupuesto:true,  contabilidad:true,  rrhh:true,  marketing:true,  calendario:true,  comunicaciones:true,  configuracion:true,  usuarios:true,  admin:true,  mi_ot:false, doc_empresa:true  },
  gerente_tal:  { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:true,  ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:true,  marketing:true,  calendario:true,  comunicaciones:true,  configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:true  },
  gerente_fin:  { dashboard:true,  pos:true,  descarga:true,  clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:false, inventario:false, bodegas:false, proveedores:true,  compras:true,  activos:true,  envios:true,  facturacion:true,  bancos:true,  finanzas:true,  presupuesto:true,  contabilidad:true,  rrhh:true,  marketing:false, calendario:false, comunicaciones:true,  configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:true  },
  recepcionista:{ dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:false,  ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:true,  venta_granos:true,  inventario:false, bodegas:false, proveedores:false, compras:false, activos:false, envios:true,  facturacion:true,  bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  vendedor:     { dashboard:true,  pos:true,  descarga:true,  clientes:true,  vehiculos:true,  diagnostico_obd:false,  ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:true,  inventario:false, bodegas:false, proveedores:false, compras:false, activos:false, envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:true,  calendario:false, comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  mecanico:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:true,  diagnostico_obd:true,  ordenes:true,  cotizaciones:true,  herreria:true,  peleteria:true,  electronica:true,  refrigeracion:true,  agroservicio:false, venta_granos:false, inventario:true,  bodegas:true,  proveedores:false, compras:false, activos:false, envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  contador:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:true,  inventario:false, bodegas:false, proveedores:true,  compras:true,  activos:true,  envios:false, facturacion:true,  bancos:true,  finanzas:true,  presupuesto:true,  contabilidad:true,  rrhh:false, marketing:false, calendario:true,  comunicaciones:true,  configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  bodeguero:    { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:true,  inventario:true,  bodegas:true,  proveedores:true,  compras:true,  activos:false, envios:true,  facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  limpieza:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:false, inventario:false, bodegas:false, proveedores:false, compras:false, activos:false, envios:false, facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  conserje:     { dashboard:true,  pos:false, descarga:true,  clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:false, inventario:false, bodegas:false, proveedores:false, compras:false, activos:false, envios:false, facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:true,  comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:false, doc_empresa:false },
  cliente:      { dashboard:false, pos:false, descarga:false, clientes:false, vehiculos:false, diagnostico_obd:false, ordenes:false, cotizaciones:false, herreria:false, peleteria:false, electronica:false, refrigeracion:false, agroservicio:false, venta_granos:false, inventario:false, bodegas:false, proveedores:false, compras:false, activos:false, envios:false, facturacion:false, bancos:false, finanzas:false, presupuesto:false, contabilidad:false, rrhh:false, marketing:false, calendario:false, comunicaciones:false, configuracion:false, usuarios:false, admin:false, mi_ot:true,  doc_empresa:false }
};
...
const MODULOS_PRECIOS = {
  ...
  agroservicio: 89, venta_granos: 79, diagnostico_obd: 99
};
...
const MODULOS_VENDIBLES = [
  ...
  'agroservicio','venta_granos','diagnostico_obd'
];
