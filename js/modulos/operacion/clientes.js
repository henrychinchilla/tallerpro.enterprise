/* Clientes Module — alta y ficha BÁSICA, para cualquier vertical.

   Los datos que exige la Ley de Armas (DPI completo, vecindad, licencia,
...
Modulos.clientes = {
  ...
  async modalForm(id=null, onGuardado=null) {
    ...
    UI.modal(`${esEdicion?'✏️ Editar':'＋ Nuevo'} Cliente`, `
      ...
      <div class="form-row">
        <div class="form-group" style="flex:2"><label class="form-label">Dirección</label>
          <input class="form-input" id="cli-dir" value="${UI.esc(c.direccion||'')}"></div>
      </div>
