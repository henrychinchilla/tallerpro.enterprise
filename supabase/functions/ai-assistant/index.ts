...
Campos esperados:
{
  ...
  "nacionalidad": "El campo NACIONALIDAD del anverso, TAL CUAL viene (código ISO de 3 letras, ej. 'GTM'). Si no aparece, null",
  "pais_nacimiento": "El campo PAÍS DE NAC. del anverso, TAL CUAL viene (código ISO de 3 letras, ej. 'GTM'). OJO: es OTRO campo, distinto de NACIONALIDAD — están uno junto al otro y en un guatemalteco de nacimiento dicen lo mismo, pero en una persona naturalizada NO coinciden. Léelos por separado y no copies uno en el otro. Si no aparece, null",
