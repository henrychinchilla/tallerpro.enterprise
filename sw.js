...
const CACHE_VERSION = 'v5.17.3-20260922-banco-desde-actuadores';
...
const PRECACHE = [
  ...
  '/js/modulos/especializados/clientes-armeria.js',
  '/js/modulos/especializados/armeria.js',
  '/js/modulos/especializados/armeria-declaraciones.js',
